      ...
      conn.ev.on("messages.upsert", async (m) => {
        ...
        if (
          ...
          (msg.type == "groupInviteMessage" ||
              (typeof msg.body === "string" && msg.body.match(/^https:\/\/chat\.whatsapp\.com\/[a-zA-Z0-9]/)))
      ) {
          if (typeof msg.body === "string" && msg.body.match(/^https:\/\/chat\.whatsapp\.com\/[a-zA-Z0-9]/))
        ...
        plugins.commands.map(async (command) => {
         /*try{*/ if (config.DISABLE_PM && !msg.isGroup || config.DISABLE_GRP && msg.isGroup) return;
