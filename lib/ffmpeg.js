...
async function sendBassAudio(message){
   ...
   let media = await message.client.downloadAndSaveMediaMessage(_message)
    await ffmpeg(media)
        ...
        .save("./assets/bass.mp3")
        .on('end', async () => {
            await message.client.sendMessage(message.from, {
                audio: fs.readFileSync('./assets/bass.mp3'),
                mimetype: 'audio/mp4',
                ptt: false
            })
        });
...
async function sendFastAudio(message){
   ...
   let media = await message.client.downloadAndSaveMediaMessage(_message)
    await ffmpeg(media)
        ...
        .save("./assets/bhass.mp3")
        .on('end', async () => {
            await message.client.sendMessage(message.from, {
                audio: fs.readFileSync('./assets/bhass.mp3'),
                mimetype: 'audio/mp4',
                ptt: false
            })
     });
...
async function sendFatAudio(message){
   ...
   let media = await message.client.downloadAndSaveMediaMessage(_message)
    await ffmpeg(media)
        ...
        .save("./assets/bgass.mp3")
        .on('end', async () => {
            await message.client.sendMessage(message.from, {
                audio: fs.readFileSync('./assets/bgass.mp3'),
                mimetype: 'audio/mp4',
                ptt: false
            })
        });   
...
async function sendSquirrelAudio(message){
   ...
   let media = await message.client.downloadAndSaveMediaMessage(_message)
    await ffmpeg(media)
        ...
        .save("./assets/beass.mp3")
        .on('end', async () => {
            await message.client.sendMessage(message.from, {
                audio: fs.readFileSync('./assets/beass.mp3'),
                mimetype: 'audio/mp4',
                ptt: false
            })
        });  
